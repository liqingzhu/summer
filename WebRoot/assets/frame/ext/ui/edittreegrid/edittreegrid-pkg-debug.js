...
//		console.log(n);console.log("==||==");console.log(changes);
        var params = {}, options = {
            node: n,
            changes: changes
        };
		...
		params.parentPath = n.parentNode.getPath();
        var cm = this.columns;
        Ext.iterate(changes, function(name, value) {
            var index = 0, c;
            for (var i = 0, len = cm.length; i < len; i++) {
    ...
    removeNode: function(n) {
		...
		console.log(n.parentNode);console.log("========");*/
        ...
        console.log("=========||========");console.log(n.attributes.parentPath);console.log("========||=======");
        var params = {
            id: n.id,
            parentNodeId: parentNode.attributes.depid,
            parentPath:n.attributes.parentPath
        };
